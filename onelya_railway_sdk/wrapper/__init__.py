...
class CarPriceInfo(object):
    def __init__(self, json_data):
        ...
        self.has_place_near_babies = json_data.get('HasPlacesNearBabies', None)
        self.has_place_near_playground = json_data.get('HasPlacesNearPlayground', None)
        self.has_place_near_pets = json_data.get('HasPlacesNearPets', None)
